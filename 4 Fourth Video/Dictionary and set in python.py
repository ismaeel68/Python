...
print(student["name2"]) #if by mistakely i add 2 with the name and this print give me the error 
print(student.get("name2")) #but this not give me the error this print give me the none
